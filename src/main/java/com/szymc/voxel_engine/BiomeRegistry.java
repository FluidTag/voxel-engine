...
public class BiomeRegistry {
	...
	public static void init() {
		...
		register(new Biome(BiomeType.BIRCH_FOREST, "Birch Forest", Blocks.BIRCH_GRASS, Blocks.DIRT,
				Blocks.BIRCH_WOOD, Blocks.BIRCH_LEAVES, 0.78f, 0.07f, new byte[] {Blocks.GRASS_DECORATION, Blocks.RED_FLOWER, Blocks.YELLOW_FLOWER, Blocks.RED_MUSHROOM_SMALL, Blocks.BROWN_MUSHROOM_SMALL}));
